...
export const certificates: Certificate[] = [
  {
    ...
    description:
      "Reconocimiento otorgado por la excelencia académica y el destacado desempeño en las artes plásticas durante el periodo de formación.",
  ...
  },
  {
    ...
    year: 2021,
    description:
      "Distinción honorífica por la contribución al desarrollo cultural y artístico de la comunidad a través de la exposición de obras.",
  ...
  },
  {
    ...
    year: 2023,
    description:
      "Galardón obtenido en certamen competitivo por la originalidad técnica y conceptual presentada en la obra concursante.",
